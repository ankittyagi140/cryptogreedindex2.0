...
export const metadata: Metadata = {
  title: "Disclaimer | Crypto Greed Index",
  description:
    "Understand the limitations of Crypto Greed Index analytics with our site disclaimer.",
};
    ...
    <article className="prose prose-invert max-w-none">
      ...
      <ul>
        <li>
          ...
          “Our” in this Disclaimer) refers to cryptogreedindex.com.
        </li>
        <li>
      ...
      <p>
        ...
        action of contract, negligence or other tort, arising out of or in connection with
        the use of the Service or the contents of the Service. The Company reserves the
        right to make additions, deletions, or modifications to the contents on the
      ...
      <p>
        ...
        content of the Service is both current and accurate, errors can occur. Plus, given
        the changing nature of laws, rules and regulations, there may be delays, omissions
        or inaccuracies in the information contained on the Service.
      </p>
      ...
      <p>
        The Service may contain views and opinions which are those of the authors and do
        not necessarily reflect the official policy or position of any other author,
        agency, organization, employer or company, including the Company.
      </p>
      <p>
        Comments published by users are their sole responsibility and the users will take
        full responsibility, liability and blame for any libel or litigation that results
        from something written in or as a direct result of something written in a comment.
      ...
      <ul>
        <li>
          By email: <a href="mailto:cryptogreedindex@gmail.com">cryptogreedindex@gmail.com</a>
        </li>
        <li>
