...
export const metadata: Metadata = {
  title: "Terms & Conditions | Crypto Greed Index",
  description:
    "Read the Crypto Greed Index terms and conditions governing your use of this site.",
};
...
export default function TermsPage() {
  return (
    <article className="prose prose-invert max-w-none">
      ...
      <ul>
        <li>
          Email: <a href="mailto:cryptogreedindex@gmail.com">cryptogreedindex@gmail.com</a>
        </li>
        <li>
          Website: <a href="https://www.cryptogreedindex.com/contact">https://www.cryptogreedindex.com/contact</a>
        </li>
      </ul>
    </article>
  );
